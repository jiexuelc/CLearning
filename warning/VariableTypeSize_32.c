/*************************************************************************
	> File Name: VariableTypeSize_32.c
	> Author: jiexue
	> Mail: jiexuelc@163.com
	> Created Time: Tue 11 Sep 2018 10:19:43 AM CST
	> Description: ubuntu32位GCC下面各变量类型大小
 ************************************************************************/
 ...
 * 注意:32位GCC默认对齐为4字节,VS2010即便是32位编译默认对齐也为8字节
 */
struct person {
...
/*
 * #pragma pack(1/2/4/8)修改默认对齐字节数
 * 修改为8时在32位GCC编译器上不一定奏效,但在VS2010上奏效
 */
#pragma pack(2)
struct Pragma_2
{
...
int main(void)
{
    ...
    char* names[9] = {"Tom","Jerry","Ham","Jobs","","Benson","Nick","Evan","jiexue"};
